...
window.WEAVE_I18N = {
  en: {
    ...
    learn: {
      ...
      eyebrow: "Literacy tracks",
      lead: "Practice in two tracks: AI literacy, and climate resilience (under sustainability), drawing on UNDRR and the Sendai Framework. Progress stays on your device.",
      ...
      resources: "UNDRR & further reading",
      skills: "Skills",
      sdgs: "SDGs",
      back: "← All practice",
      minutes: "min",
      all: "All",
      trackAi: "AI literacy",
      trackClimate: "Climate resilience",
      tracksLabel: "Practice tracks",
    },
    latest: {
      eyebrow: "Latest",
      title: "Articles",
  ...
  zh: {
    ...
    learn: {
      title: "每周练习",
      eyebrow: "素养赛道",
      lead: "两条练习赛道：AI 素养，以及归在可持续之下的气候韧性（参考联合国减灾办 UNDRR 与仙台框架）。进度只保存在本机。",
      empty: "暂无练习模块。",
      start: "开始练习",
      continue: "继续",
      completed: "已完成",
  ...
  ko: {
    ...
    learn: {
      title: "주간 실습",
      eyebrow: "리터러시 트랙",
      lead: "두 트랙으로 연습합니다: AI 리터러시, 그리고 지속가능성 아래의 기후 회복력(UNDRR·센다이 프레임워크 기반). 진행 상황은 이 기기에만 저장됩니다.",
      empty: "아직 모듈이 없습니다.",
      start: "시작하기",
      continue: "이어하기",
      completed: "완료",
